...
public class UserService {
    ...
    public List<User> getEmployeesWithoutLeave() {
        List<User> employees = new ArrayList<>();
        String query = "SELECT * FROM users u WHERE u.role = 'EMPLOYE' AND u.id NOT IN (SELECT c.idUser FROM conge c WHERE c.statut = 'PENDING' OR c.statut = 'APPROVED')";
