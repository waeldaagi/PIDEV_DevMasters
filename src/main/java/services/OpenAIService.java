...
public class OpenAIService {
    ...
    private static final String OPENAI_URL = "https://api.openai.com/v1/chat/completions"; // chat gpt 4
    private static final String DALL_E_URL = "https://api.openai.com/v1/images/generations";// dall e 3
