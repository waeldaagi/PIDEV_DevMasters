...
public class AfficherOffreRecrutementController {
    ...
    void demande_go(ActionEvent event) {
        ...
        if (idOffre != null) {
            try {
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/rh/AfficherDemande.fxml"));
    ...
    void go_ajout(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/rh/AjoutOffreRecrutement.fxml"));
            Parent root = loader.load();
