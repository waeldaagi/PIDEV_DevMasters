...
public class MainController {
    ...
    private void handleEquipesButton() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/equipe/afficherEquipe.fxml"));
    ...
    private void handleProjetsButton() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/projet/afficherProjets.fxml"));
            Parent root = loader.load();
            Stage stage = new Stage();
