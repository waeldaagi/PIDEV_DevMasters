...
public class AfficherEquipeController implements Initializable {
    ...
    private void ajouterEquipe(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/equipe/ajoutEquipe.fxml"));
    ...
    private void handleModifierButtonClick() {
        ...
        if (selectedEquipe != null) {
            try {
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/equipe/modifierEquipe.fxml"));
                Parent root = loader.load();
