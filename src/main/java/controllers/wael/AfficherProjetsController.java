...
public class AfficherProjetsController implements Initializable {
    ...
    private void handleChatbotButtonClick() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/projet/chatbot.fxml"));
            Parent root = loader.load();
    ...
    private void handleViewDetailsButtonClick(Projet projet) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/projet/detailsProjet.fxml"));
            Parent root = loader.load();
